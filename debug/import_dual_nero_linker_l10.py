...
class Example:
    ...
    def setup_quest_teleop(self, args) -> None:
        ...
        from rexpolicy.robots.newton_runtime import NewtonRuntimeRobotConfig, NewtonRuntimeRobotInterface
        from rexpolicy.session.overlay_hand_log_session import OverlayHandLogSession, OverlayHandLogSessionConfig
        from rexpolicy.session.quest_session import QuestRobotSession, QuestRobotSessionConfig
        from rexpolicy.session.voice_controls import VoiceTeleopControlConfig, VoiceTeleopControlPolicy
        from rexpolicy.session.xr_status import XrTeleopStatusPublisher
